...
configure_package() {
  ...
  KODI_LIBDVD="${KODI_DVDCSS} \
               -DLIBDVDNAV_URL=${SOURCES}/libdvdnav/libdvdnav-$(get_pkg_version libdvdnav).tar.bz2 \
               -DLIBDVDREAD_URL=${SOURCES}/libdvdread/libdvdread-$(get_pkg_version libdvdread).tar.bz2"
